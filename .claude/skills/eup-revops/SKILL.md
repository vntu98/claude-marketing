---
name: eup-revops
description: "When the user wants help with revenue operations, lead lifecycle management, or marketing-to-sales handoff processes. Also use when the user mentions 'RevOps,' 'revenue operations,' 'lead scoring,' 'lead routing,' 'MQL,' 'SQL,' 'pipeline stages,' 'deal desk,' 'CRM automation,' 'marketing-to-sales handoff,' 'data hygiene,' 'leads aren't getting to sales,' 'pipeline management,' 'lead qualification,' or 'when should marketing hand off to sales.' Use this for anything involving the systems and processes that connect marketing to revenue. For lifecycle emails, see eup-email-sequence. For strategy-level GTM decisions, pair with eup-strategy."
context: fork
agent: revops-manager
...
- **eup-email-sequence**: For lifecycle and nurture email flows
- **eup-analytics**: For tracking pipeline metrics and attribution
- **eup-launch**: For go-to-market launch planning
- **eup-copywriting**: For handoff copy, nurture assets, and lifecycle messaging
- **eup-strategy**: For GTM priorities and packaging context
